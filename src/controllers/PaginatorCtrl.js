...
export default class PaginatorCtrl extends Controller {
  ...
  async loader(trx) {
    ...
    await this.loadCSS('https://www.w3schools.com/w3css/4/w3.css');
    await this.loadView('#main', 'pages/paginator/main.html');
  }
  ...
  async destroy(trx) {
    await this.unloadCSS('https://www.w3schools.com/w3css/4/w3.css');
  }
